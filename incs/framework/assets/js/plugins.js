...
(function($) {
  ...
  function WUPPOAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  WUPPOAjaxChosen.prototype.init = function() {
  ...
  WUPPOAjaxChosen.prototype.events = function() {
  ...
  WUPPOAjaxChosen.prototype.search_field_focused = function() {
  ...
  WUPPOAjaxChosen.prototype.search_welcome_message = function() {
  ...
  WUPPOAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('wuppo-chosen', _this.options.data).done( function( response ) {
  ...
  WUPPOAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.wuppo-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.WUPPOChosenOrder($hidden_value, true);
  ...
  $.fn.WUPPOAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new WUPPOAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, WUPPOAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  WUPPOAbstractChosenOrder = (function() {

    function WUPPOAbstractChosenOrder() {}

    WUPPOAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    WUPPOAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    WUPPOAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    WUPPOAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    WUPPOAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    WUPPOAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    WUPPOAbstractChosenOrder.WUPPOChosenOrder = function(select, order, force) {
    ...
    return WUPPOAbstractChosenOrder;
  ...
  $.fn.extend({
    WUPPOChosenOrder: function(order, force) {
      return _WUPPOChosenOrder.WUPPOChosenOrder(this, order, force);
    }
  });

  this._WUPPOChosenOrder = (function(_super) {
    __extends(_WUPPOChosenOrder, _super);

    function _WUPPOChosenOrder() {
      _ref = _WUPPOChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _WUPPOChosenOrder.relAttributeName = 'data-option-array-index';

    _WUPPOChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _WUPPOChosenOrder.getDOMElement = function(element) {
    ...
    _WUPPOChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _WUPPOChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _WUPPOChosenOrder;

  })(WUPPOAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('wuppo-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Wuppo: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Wuppo: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectWUPPO = FormSerializer.serializeObject;
    $.fn.serializeJSONWUPPO   = FormSerializer.serializeJSON;
  }
