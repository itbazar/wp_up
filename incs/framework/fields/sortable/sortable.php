 ...
 *
 */
if ( ! class_exists( 'WUPPO_Field_sortable' ) ) {
  class WUPPO_Field_sortable extends WUPPO_Fields {
    ...
    public function render() {
      ...
      echo '<div class="wuppo-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="wuppo-sortable-item">';

          echo '<div class="wuppo-sortable-content">';
          ...
          WUPPO::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="wuppo-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
