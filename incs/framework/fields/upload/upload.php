 ...
 *
 */
if ( ! class_exists( 'WUPPO_Field_upload' ) ) {
  class WUPPO_Field_upload extends WUPPO_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="wuppo--preview'. esc_attr( $preview_hidden ) .'">';
      ...
      echo '<a href="#" class="button button-primary wuppo--button" data-library="'. esc_attr( $library ) .'">'. $args['button_title'] .'</a>';
      echo '<a href="#" class="button button-secondary wuppo-warning-primary wuppo--remove'. esc_attr( $hidden ) .'">'. $args['remove_title'] .'</a>';
      echo '</div>';
