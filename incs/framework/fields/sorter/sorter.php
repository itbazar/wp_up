 ...
 *
 */
if ( ! class_exists( 'WUPPO_Field_sorter' ) ) {
  class WUPPO_Field_sorter extends WUPPO_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'wuppo' ),
        'disabled_title' => esc_html__( 'Disabled', 'wuppo' ),
      ) );
      ...
      echo '<div class="wuppo-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="wuppo-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="wuppo-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="wuppo-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="wuppo-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="wuppo-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="wuppo-disabled">';
