 ...
 *
 */
if ( ! class_exists( 'WUPPO_Field_palette' ) ) {
  class WUPPO_Field_palette extends WUPPO_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $palette ) ) {
        ...
        echo '<div class="wuppo-siblings wuppo--palettes">';

        foreach ( $palette as $key => $colors ) {

          $active  = ( $key === $this->value ) ? ' wuppo--active' : '';
          $checked = ( $key === $this->value ) ? ' checked' : '';

          echo '<div class="wuppo--sibling wuppo--palette'. esc_attr( $active ) .'">';
