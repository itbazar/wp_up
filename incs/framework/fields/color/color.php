 ...
 *
 */
if ( ! class_exists( 'WUPPO_Field_color' ) ) {
  class WUPPO_Field_color extends WUPPO_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="wuppo-color"'. $default_attr . $this->field_attributes() .'/>';
