/*=========================================================================================
  ...
  ----------------------------------------------------------------------------------------
  Item Name: USER PANEL plugin 
  Author: webiha
  Author URL: http://wpuserpanel.com
==========================================================================================*/
window.colors = {
  solid: {
    primary: '#7367F0',
...
(function (window, document, $) {
  ...
  $(document).on('click', '.menu-toggle, .modern-nav-toggle', function (e) {
    ...
    // Save menu collapsed status in localstorage (uncomment below code to enable menu collapsed state)
     if ($body.hasClass('menu-expanded') || $body.hasClass('menu-open')) {
