...
<div class="row">
    <div class="col-12 col-md-8 m-auto card p-0">
        <table class="table table-hover text-center">
			...
			<?php if ( filter_var( $edd_receipt_args['payment_id'], FILTER_VALIDATE_BOOLEAN ) ) : ?>
                <tr>
                    <th class="text-center"><strong><?php _e( 'Payment', 'easy-digital-downloads' ); ?>:</strong></th>
                    <th class="text-center"><?php echo edd_get_payment_number( $payment->ID ); ?></th>
                </tr>
			<?php endif; ?>
            </thead>
            ...
            <tr>
                <td class="edd_receipt_payment_status">
                    <strong><?php _e( 'Payment Status', 'easy-digital-downloads' ); ?>
                        :</strong></td>
			...
			<?php if ( filter_var( $edd_receipt_args['discount'], FILTER_VALIDATE_BOOLEAN ) && isset( $user['discount'] ) && $user['discount'] != 'none' ) : ?>
                <tr>
                    <td class="text-center"><strong><?php _e( 'Discount(s)', 'easy-digital-downloads' ); ?>:</strong></td>
                    <td class="text-center"><?php echo $user['discount']; ?></td>
                </tr>
			<?php endif; ?>
...
<?php if ( filter_var( $edd_receipt_args['products'], FILTER_VALIDATE_BOOLEAN ) ) : ?>
    ...
    <div class="row">
        <div class="col-12 p-0">
            <h3 class="mt-5 h4"><?php echo apply_filters( 'edd_payment_receipt_products_title', __( 'Products', 'easy-digital-downloads' ) ); ?></h3>
        </div>
	    <div class="clearfix"></div>
        <div class="col-12 col-md-8 m-auto card p-0">
            <table class="table table-hover text-center">
                <thead>
                <th class="text-center"><?php _e( 'Name', 'easy-digital-downloads' ); ?></th>
				<?php if ( edd_use_skus() ) { ?>
                    <th class="text-center"><?php _e( 'SKU', 'easy-digital-downloads' ); ?></th>
				<?php } ?>
				<?php if ( edd_item_quantities_enabled() ) : ?>
                    <th class="text-center"><?php _e( 'Quantity', 'easy-digital-downloads' ); ?></th>
				<?php endif; ?>
                <th class="text-center"><?php _e( 'Price', 'easy-digital-downloads' ); ?></th>
                </thead>
                            ...
                            <tr>
                                <td>
									...
									if ( edd_is_payment_complete( $payment->ID ) && edd_receipt_show_download_files( $item['id'], $edd_receipt_args, $item ) ) : ?>
                                        <ul class="edd_purchase_receipt_files" style="list-style: none!important;">
											<?php
