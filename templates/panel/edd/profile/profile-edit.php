<div class="row pr-4 pl-4">
    <div class="col-12 p-0">
		...
		if (is_user_logged_in()):
            ...
            <div class="edd_success edd-alert edd-alert-success">
                <strong><?php _e('Success', 'easy-digital-downloads'); ?>
                    :</strong> <?php _e('Your profile has been edited successfully.', 'easy-digital-downloads'); ?>
            </div>
		<?php endif; ?>
            ...
            <form id="edd_profile_editor_form" class="edd_form"
                  action="<?php echo edd_get_current_page_url() .'?page='. WUPPTools::wupp_get_menu_link_by_slug('edd_account_menus', 'edd_edit_profile'); ?>" method="post">
                    ...
                    <div class="form-row">
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_first_name_wrap">
                                ...
                                <input name="edd_first_name" id="edd_first_name" class="form-control text edd-input" type="text"
                        ...
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_last_name_wrap">
                                ...
                                <input name="edd_last_name" id="edd_last_name" class="form-control text edd-input" type="text"
                        ...
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_display_name_wrap">
                                ...
                                <select name="edd_display_name" id="edd_display_name"
                                        class="form-control select edd-select">
                            ...
                            <p id="edd_profile_primary_email_wrap">
								...
								<?php if ($customer->id > 0) : ?>
									<?php if (1 === count($customer->emails)) : ?>
                                        <input name="edd_email" id="edd_email" class="form-control text edd-input required"
                                               type="email" value="<?php echo esc_attr($customer->email); ?>"/>
									<?php else: ?>
										<?php
										$emails           = array();
								...
								<?php else: ?>
                                    <input name="edd_email" id="edd_email" class="form-control text edd-input required"
                                           type="email" value="<?php echo esc_attr($current_user->user_email); ?>"/>
								<?php endif; ?>
						...
						<?php if ($customer->id > 0 && count($customer->emails) > 1) : ?>
                            ...
                            <ul class="edd-profile-emails">
								...
								<a href="<?php echo $remove_url ?>"
                                   class="delete btn btn-sm btn-danger"><?php _e('Remove', 'easy-digital-downloads'); ?></a>
							</span>
                                    </li>
								<?php endforeach; ?>
                            </ul>
                    ...
                    <div class="form-row">
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_billing_address_line_1_wrap">
                                ...
                                <input name="edd_address_line1" id="edd_address_line1" class="form-control text edd-input"
                                       type="text" value="<?php echo esc_attr($address['line1']); ?>"/>
                            </p>
                        </div>
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_billing_address_line_2_wrap">
                                <label for="edd_address_line2"><?php _e('Line 2', 'easy-digital-downloads'); ?></label>
                                <input name="edd_address_line2" id="edd_address_line2" class="form-control text edd-input"
                                       type="text" value="<?php echo esc_attr($address['line2']); ?>"/>
                            </p>
                        </div>
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_billing_address_city_wrap">
                                <label for="edd_address_city"><?php _e('City', 'easy-digital-downloads'); ?></label>
                                <input name="edd_address_city" id="edd_address_city" class="form-control text edd-input"
                                       type="text" value="<?php echo esc_attr($address['city']); ?>"/>
                            </p>
                        </div>
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_billing_address_postal_wrap">
                                ...
                                <input name="edd_address_zip" id="edd_address_zip" class="form-control text edd-input"
                                       type="text" value="<?php echo esc_attr($address['zip']); ?>"/>
                            </p>
                        </div>
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_billing_address_country_wrap">
                                <label for="edd_address_country"><?php _e('Country', 'easy-digital-downloads'); ?></label>
                                <select name="edd_address_country" id="edd_address_country"
                                        class="form-control select edd-select"
                        ...
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_billing_address_state_wrap">
								...
								<?php if (!empty($states)) : ?>
                                    <select name="edd_address_state" id="edd_address_state"
                                            class="form-control select edd-select">
										<?php
								...
								<?php else : ?>
                                    <input name="edd_address_state" id="edd_address_state" class="form-control text edd-input"
                                           type="text" value="<?php echo esc_attr($state); ?>"/>
								<?php endif; ?>
                    ...
                    <div class="form-row">
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_password_wrap">
                                ...
                                <input name="edd_new_user_pass1" id="edd_new_user_pass1"
                                       class="form-control password edd-input"
                                       type="password"/>
                            </p>
                        </div>
                        <div class="col-12 col-md-6 form-group">
                            <p id="edd_profile_confirm_password_wrap">
                                ...
                                <input name="edd_new_user_pass2" id="edd_new_user_pass2"
                                       class="form-control password edd-input"
                                       type="password"/>
                ...
                <fieldset id="edd_profile_submit_fieldset">
                    ...
                    <p id="edd_profile_submit_wrap">
                        ...
                        <input type="hidden" name="edd_redirect"
                               value="<?php echo esc_url(edd_get_current_page_url()); ?>"/>
